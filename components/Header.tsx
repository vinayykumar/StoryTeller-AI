  ...
  return (
    <header className="relative p-16 text-center">
        <Link href='/' >
            ...
            <div className="flex space-x-5 text-3xl lg:text-5xl justify-center whitespace-nowrap mr-14">
                <h2>Bringing your stories</h2>
                <div className="relative">
                    <div className="absolute bg-purple-500 -left-2 -top-1 -bottom-1 -right-2 md:-left-3 md:-top-0 md:-bottom-0 md:-right-3 -rotate-1 md:w-36">
